        ...
        <nav class="navbar navbar-default" role="navigation" data-spy="affix" data-offset-top="50">
          <div class="container">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand logo" href="index"><img class="" src="img/logo1.png" alt="Vietnamworks - Job Search, career and employment in Vietnam" title="Vietnamworks - Job Search, career and employment in Vietnam" height="40px" width="110px"></a>
            </div>
...
{{--                 <li>
              ...
              <li style="" class="left"><a href="nhatuyendung/trangchu" target="_blank"><i class="ti-pencil-alt"></i> TUYỂN DỤNG</a></li>
              @if(Auth::user())
                    ...
                    <div class="row">
                      <div class="col-md-11 col-sm-6">
                        <div class="form-group">
                          <input class="form-control" name="timkiem" type="text" placeholder="Nhập ngành nghề, công ty, vị trí ứng tuyển">
                          <i class="ti-time"></i>
                        </div>
                      </div>
